...
int day_limit=400, night_limit=450; // analog reading levels corresponding to switching from day to night - difference used to avoid toggling between two levels when light level is borderline
